static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_ARNOLD - 1] = {MAP_GROUP(ARNOLD), MAP_NUM(ARNOLD), 10, 8},
    [HEAL_LOCATION_ANNAPOLIS - 1] = {MAP_GROUP(ANNAPOLIS), MAP_NUM(ANNAPOLIS), 9, 12},
    [HEAL_LOCATION_ANNAPOLIS2 - 1] = {MAP_GROUP(ANNAPOLIS2), MAP_NUM(ANNAPOLIS2), 33, 20},
    [HEAL_LOCATION_OAKLAND - 1] = {MAP_GROUP(OAKLAND), MAP_NUM(OAKLAND), 8, 8},
    [HEAL_LOCATION_SEVERNA_PARK - 1] = {MAP_GROUP(SEVERNA_PARK), MAP_NUM(SEVERNA_PARK), 8, 4},
    [HEAL_LOCATION_ROUTE12 - 1] = {MAP_GROUP(ROUTE12), MAP_NUM(ROUTE12), 12, 4},
    [HEAL_LOCATION_BALTIMORE - 1] = {MAP_GROUP(BALTIMORE), MAP_NUM(BALTIMORE), 33, 19},
    [HEAL_LOCATION_HAVRE_DE_GRACE - 1] = {MAP_GROUP(HAVRE_DE_GRACE), MAP_NUM(HAVRE_DE_GRACE), 12, 8},
    [HEAL_LOCATION_FREDERICK - 1] = {MAP_GROUP(FREDERICK), MAP_NUM(FREDERICK), 22, 12},
    [HEAL_LOCATION_HAGERSTOWN - 1] = {MAP_GROUP(HAGERSTOWN), MAP_NUM(HAGERSTOWN), 12, 8},
    [HEAL_LOCATION_CUMBERLAND - 1] = {MAP_GROUP(CUMBERLAND), MAP_NUM(CUMBERLAND), 12, 10},
    [HEAL_LOCATION_ROCKVILLE - 1] = {MAP_GROUP(ROCKVILLE), MAP_NUM(ROCKVILLE), 12, 18},
    [HEAL_LOCATION_LA_PLATA - 1] = {MAP_GROUP(LA_PLATA), MAP_NUM(LA_PLATA), 8, 10},
    [HEAL_LOCATION_CAMBRIDGE - 1] = {MAP_GROUP(CAMBRIDGE), MAP_NUM(CAMBRIDGE), 20, 18},
    [HEAL_LOCATION_SALISBURY - 1] = {MAP_GROUP(SALISBURY), MAP_NUM(SALISBURY), 10, 12},
    [HEAL_LOCATION_DC - 1] = {MAP_GROUP(DC), MAP_NUM(DC), 18, 18},
};
