static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_ARNOLD - 1] = {MAP_GROUP(ARNOLD), MAP_NUM(ARNOLD), 16, 5},
    [HEAL_LOCATION_ANNAPOLIS - 1] = {MAP_GROUP(ANNAPOLIS), MAP_NUM(ANNAPOLIS), 9, 9},
    [HEAL_LOCATION_ANNAPOLIS2 - 1] = {MAP_GROUP(ANNAPOLIS2), MAP_NUM(ANNAPOLIS2), 33, 20},
    [HEAL_LOCATION_OAKLAND - 1] = {MAP_GROUP(OAKLAND), MAP_NUM(OAKLAND), 14, 5},
    [HEAL_LOCATION_SEVERNA_PARK - 1] = {MAP_GROUP(SEVERNA_PARK), MAP_NUM(SEVERNA_PARK), 19, 10},
    [HEAL_LOCATION_ROUTE12 - 1] = {MAP_GROUP(ROUTE12), MAP_NUM(ROUTE12), 10, 8},
    [HEAL_LOCATION_BALTIMORE - 1] = {MAP_GROUP(BALTIMORE), MAP_NUM(BALTIMORE), 11, 33},
    [HEAL_LOCATION_HAVRE_DE_GRACE - 1] = {MAP_GROUP(HAVRE_DE_GRACE), MAP_NUM(HAVRE_DE_GRACE), 5, 22},
    [HEAL_LOCATION_FREDERICK - 1] = {MAP_GROUP(FREDERICK), MAP_NUM(FREDERICK), 22, 18},
    [HEAL_LOCATION_HAGERSTOWN - 1] = {MAP_GROUP(HAGERSTOWN), MAP_NUM(HAGERSTOWN), 19, 10},
    [HEAL_LOCATION_CUMBERLAND - 1] = {MAP_GROUP(CUMBERLAND), MAP_NUM(CUMBERLAND), 16, 17},
    [HEAL_LOCATION_ROCKVILLE - 1] = {MAP_GROUP(ROCKVILLE), MAP_NUM(ROCKVILLE), 3, 17},
    [HEAL_LOCATION_LA_PLATA - 1] = {MAP_GROUP(LA_PLATA), MAP_NUM(LA_PLATA), 13, 17},
    [HEAL_LOCATION_CAMBRIDGE - 1] = {MAP_GROUP(CAMBRIDGE), MAP_NUM(CAMBRIDGE), 35, 24},
    [HEAL_LOCATION_SALISBURY - 1] = {MAP_GROUP(SALISBURY), MAP_NUM(SALISBURY), 7, 12},
    [HEAL_LOCATION_DC - 1] = {MAP_GROUP(DC), MAP_NUM(DC), 71, 37},
    [HEAL_LOCATION_ARNOLD_PLAYERS_HOUSE_2F - 1] = {MAP_GROUP(ARNOLD_PLAYERS_HOUSE_2F), MAP_NUM(ARNOLD_PLAYERS_HOUSE_2F), 4, 2},
};
